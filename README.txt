...
#Keep in mind that the FQDN provided for the RDS instance would be different if deployed in another region. Also, you need to set up a db_password in variables.tf
